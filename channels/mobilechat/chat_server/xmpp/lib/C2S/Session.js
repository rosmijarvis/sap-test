...
Session.prototype.send = function (stanza) {
  ...
  // {
  //     console.log("ok whatever:: "+stanza.toString());
...
Session.prototype.onRegistration = function (stanza) {
  ...
  if (stanza.attrs.type === 'get') {
    ...
    this.emit('register', {
      ...
      email: register.getChildText('email'),
      mobile_number: register.getChildText('mobile_number'),
      imei_number: register.getChildText('imei_number'),
      thales_tgi: register.getChildText('thales_tgi'),
      otp: register.getChildText('otp'),
      action_type: register.getChildText('action_type'),
      userpassword: register.getChildText('userpassword'),
      oldpassword: register.getChildText('oldpassword'),
      newpassword: register.getChildText('newpassword'),
      mobile_old: register.getChildText('mobile_old'),
      mobile_new: register.getChildText('mobile_new'),
      client: self
    }, function (error) {
      if (!error) {
