(function(window) {
  ...
  //var client = new BinaryClient('ws://127.0.0.1:9001');
   // var client = new BinaryClient('wss://localhost:8086');
  ...
  var client = new BinaryClient(gOptions.binaryServerUrl);
  var bufferSize = 2048;
...
//    	  document.getElementById('speechText').value =data;
  //  });
    ...
    window.startRecording = function() {
			recording = true;	
	        // We add the GUID as a Meta to the stream
			var meta = new Object();
			meta.guid = guid;
			console.log('Meta GUID is ---' + meta.guid);
			
			window.Stream = client.createStream(meta);
