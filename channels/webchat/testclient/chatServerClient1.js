...
var socket=io.connect('https://infarszc90963.nmumarl.lntinfotech.com:8084',{secure:true,rejectUnauthorized: false});
...
socket.emit('input-to-chatserver' , ' I am looking EBC claim ');
